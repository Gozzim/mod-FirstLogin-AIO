...
public:
    ...
    void OnBeforeConfigLoad(bool /*reload*/) override {
        ...
        FLoginStable = sConfigMgr->GetBoolDefault("FirstLogin.StableSlots", 0);
        FLoginPet = sConfigMgr->GetBoolDefault("FirstLogin.Pet", 1);
        FLoginPetName = sConfigMgr->GetIntDefault("FirstLogin.RandPetName", 0);
        FLoginBank = sConfigMgr->GetBoolDefault("FirstLogin.BankSlots", 0);
...
public:
    ...
    void OnFirstLogin(Player* player) override {
        if (FLoginEnable) {
            ...
            if (FLoginStable && player->getClass() == CLASS_HUNTER && player->m_stableSlots < MAX_PET_STABLES)
